...
//            	predicates.add(criteriaBuilder.equal(root.get("paymentStatus").as(PaymentStatus.class), filter.getPaymentStatuses()));
	...
	private static Predicate buildCriteriaForCol(CriteriaBuilder criteriaBuilder, Root<PrintJob> root, String colName, Long min, Long max) {
	...
	private static Predicate buildCriteriaForCol(CriteriaBuilder criteriaBuilder, Root<PrintJob> root, String colName, LocalDate from, LocalDate to) {
	...
	private static List<Predicate> customerFilter(CriteriaBuilder criteriaBuilder, Root<PrintJob> root, String customerName, String customerPhone) {
